...
<style>
  ...
  .envelope:hover{ box-shadow: 0 18px 44px rgba(0,0,0,0.14); }
  ...
  .env-title{ font-size: 1.18rem; line-height: 1.2; }
  .env-sub{ opacity: 0.82; font-weight: 700; margin-top: 5px; font-size: 0.98rem; }
  ...
  .pulse{ display:inline-block; animation: pulse 1.25s ease-in-out infinite; }
  @keyframes pulse{ 0%,100%{transform:scale(1)} 50%{transform:scale(1.06)} }

  .envelope.opening{ animation: envWiggle 520ms ease both; }
  @keyframes envWiggle{
  ...
  .envelope.opening::before{ transform: rotateX(70deg); }
  .envelope.opening .env-paper{ animation: paperUp 520ms ease both; }
  @keyframes paperUp{ from{transform:translateY(34px)} to{transform:translateY(4px)} }
  ...
  .envelope.opening .sparkle{ animation: sparkle 520ms ease both; }
  @keyframes sparkle{ 0%{opacity:0;transform:scale(.98)} 45%{opacity:.55} 100%{opacity:0;transform:scale(1.02)} }
</style>
</head>
<body>
  <div class="wrap">
    <div class="envelope" id="open_letter" role="button" aria-label="Open love letter" tabindex="0">
      <div class="sparkle"></div>

      <div class="env-top">
        <div>
          <div class="env-title">To: <b>$HER</b> 🍙</div>
          <div class="env-sub">From: <b>$ME</b> 🍣</div>
        </div>
...
""").substitute(HER=HER_NAME, ME=ME_NICKNAME)
